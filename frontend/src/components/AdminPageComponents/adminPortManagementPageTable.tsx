...
interface AdminPortManagementPageTableProps {
  title: string;
}

const AdminPortManagementPageTable: React.FC<AdminPortManagementPageTableProps> = ({ title }) => {
...
export default AdminPortManagementPageTable;

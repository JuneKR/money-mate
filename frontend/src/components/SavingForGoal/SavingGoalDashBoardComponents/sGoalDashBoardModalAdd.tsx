...
const SGoalDashBoardModalAdd: React.FC<SGoalDashBoardModalAddProps> = ({
  savingGoal,
}) => {
        ...
        <Box sx={style}>
          ...
          >
            ...
            <div className="py-5 text-white font-bold text-md">
              ฝากเงินสำเร็จ! กรุณารอสักครู่และกรุณาอย่าออกจากหน้านี้....
            </div>
          </Typography>
        </Box>
      </Modal>
...
export default SGoalDashBoardModalAdd;

...
import DataTable from '@/components/AdminPageComponents/adminPortManagementPageTable'


const AdminPortsManagement = () => {
...
export default AdminPortsManagement;

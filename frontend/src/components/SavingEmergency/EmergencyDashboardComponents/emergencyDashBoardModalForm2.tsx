...
interface EmergencyDashBoardModalForm2Props {
    title: string;
}
const style = {
...
const EmergencyDashBoardModalForm2: React.FC<EmergencyDashBoardModalForm2Props> = (props) => {
...
export default EmergencyDashBoardModalForm2;
                    ...
                    <div className="flex-1 px-2">
                        ...
                        <form action="#" className="my-4">
                            <div className="grid grid-cols-2 gap-4 mb-4">
                                <div>
                                    <label htmlFor="firstname" className="block">
                                        ...
                                        <input type="string" id="fname" placeholder="Input firstneme..." className="block w-full px-3 py-2 text-sm placeholder-gray-500 border border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 invalid:text-pink-700 invalid:focus:ring-pink-700 invalid:focus:border-pink-700 peer"/>
                                ...
                                <div>
                                    <label htmlFor="lastname" className="block">
                                        ...
                                        <input type="string" id="lname" placeholder="Input lastname..." className="block w-full px-3 py-2 text-sm placeholder-gray-500 border border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 invalid:text-pink-700 invalid:focus:ring-pink-700 invalid:focus:border-pink-700 peer"/>
                            ...
                            <label htmlFor="email" className="block">
                                ...
                                <input type="email" id="code" placeholder="Input email..." className="block w-full px-3 py-2 text-sm placeholder-gray-500 border border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500"/>
                            ...
                            <label htmlFor="password" className="block">
                                ...
                                <input type="password" id="password" placeholder="Input password..." minLength={5} className="block w-full px-3 py-2 text-sm placeholder-gray-500 border border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 invalid:text-pink-700 invalid:focus:ring-pink-700 invalid:focus:border-pink-700 peer"/>
                                 <p className="invisible m-1 text-xs text-pink-700 peer-invalid:visible">less than 5 characters</p>
                            </label>
                            <button type="button" className="w-full inline-flex mb-4 items-center justify-center text-gray-100  font-medium leading-none mt-8 bg-blue-600 rounded-lg py-3 px-8 border border-transparent transform-gpu hover:-translate-y-0.5  transition-all duration-150 hover:text-gray-200 hover:bg-blue-700 text-sm sm:text-base">Create account</button>

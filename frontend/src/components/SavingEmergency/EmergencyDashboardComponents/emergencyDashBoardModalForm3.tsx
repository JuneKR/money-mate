...
interface EmergencyDashBoardModalForm3Props {
    title: string;
}
const style = {
...
const EmergencyDashBoardModalForm3: React.FC<EmergencyDashBoardModalForm3Props> = (props) => {
    const [userRisk, setuserRisk] = useState('');

    const handleUserRiskChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        setuserRisk(event.target.value);
    };
...
export default EmergencyDashBoardModalForm3;
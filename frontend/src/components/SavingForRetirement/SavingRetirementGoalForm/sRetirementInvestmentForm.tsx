      ...
      >
        ...
        <div className="relative py-8 ">
          <div
            ...
            className=" bg-gradient-to-r from-purple-900 to-green-500 transform hover:scale-105 transition duration-300 ease-in-out px-4 rounded-t-lg cursor-pointer flex justify-between items-center border-2 border-black"
            onClick={handleClick}
          >
            <span

              className="text-white text-lg rounded py-2 font-bold"
            >

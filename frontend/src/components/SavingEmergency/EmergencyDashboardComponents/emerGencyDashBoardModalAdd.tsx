...
const EmerGencyDashBoardModal: React.FC<EmerGencyDashBoardModalProps> = (props) => {
    ...
    return (
      <div>
        <Button style={{ width: "209px",marginRight: "10px", backgroundColor: '#FEF5AC'}} className="px-4 py-2 font-bold text-black rounded shadow focus:shadow-outline focus:outline-none" onClick={handleOpen}>ออมเงิน</Button>
          <Modal
              open={open}
              onClose={handleClose}
